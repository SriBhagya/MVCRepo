...
namespace RemotevalidationEg.Controllers
{
	public class CustomersController : Controller
	{
		...
		public JsonResult IsCoExists(string CompanyName)
		{
			return IsCompanyExist(CompanyName) ?
				Json(true, JsonRequestBehavior.AllowGet) :
				Json(false, JsonRequestBehavior.AllowGet);
		}

		public bool IsCustomerIdExists(string CustomerId)
		{
			var result = (from cust in db.Customers
		...
		public JsonResult IsCustomerIDExists(string CustomerId)
		{
			return IsCompanyExist(CustomerId) ?
				Json(true, JsonRequestBehavior.AllowGet) :
			   Json(false, JsonRequestBehavior.AllowGet);
